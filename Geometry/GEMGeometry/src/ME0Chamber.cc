...
void ME0Chamber::add( const ME0Layer* rl ) {
...
const std::vector< const ME0Layer* >&
...
void ME0Chamber::add( const ME0EtaPartition* rl) {
  etaPartitions_.emplace_back( rl );
}

const std::vector< const ME0EtaPartition* >&
